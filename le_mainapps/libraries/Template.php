	...
	class Template {
		...
		function views($template = NULL, $data = NULL) {
			if ($template != NULL) {
				...
				//Sidebar Admin 
			/*	$data['_sidebaradmin'] 				= $this->_ci->load->view('_layout/_sidebaradmin', $data, TRUE);
				//Sidebar
				$data['_sidebarkepegawaian'] 				= $this->_ci->load->view('_layout/_sidebarkepegawaian', $data, TRUE);
				//Sidebar
				$data['_sidebarkeuangan'] 				= $this->_ci->load->view('_layout/_sidebarkeuangan', $data, TRUE);
				
				//Sidebar
				$data['_sidebarkerumahtanggaan'] 				= $this->_ci->load->view('_layout/_sidebarkerumahtanggaan', $data, TRUE);
