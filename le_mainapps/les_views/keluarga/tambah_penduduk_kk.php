...
<div class="container-fluid">
	<div class="row">
		<!-- /.col -->
		<div class="col-sm-2">
			<form action="<?php echo base_url(); ?>Keluarga/simpan_kk_baru" method="post">
				<!-- Profile Image -->
		...
		<div class="col-md-10">
			<div class="card">
				<div class="card-header p-2">
						<a type="button" onclick="window.history.go(-1)" class="btn-sm btn-info" > <i class="fa fa-arrow-circle-left "></i> Kembali Ke Halaman
							Keluarga</a>
				</div><!-- /.card-header -->
				<div class="card-body">
                    <div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								<label>No KK</label>
								<input type="text" class="" value="" name="no_kk" placeholder="Masukan No KK" required>
							</div>
						</div>
						<div class="col-sm-8">
							<div class="form-group">
								<input type="hidden" class="" value="" name="id_cluster" value="0">
							</div>
						</div>
					</div>
					<div class="row">
